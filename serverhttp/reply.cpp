...
namespace http::server3 {
    ...
    namespace status_strings {
        ...
        const std::string not_sync =
                "HTTP/1.0 305 Not Syncronized\r\n";
        ...
        boost::asio::const_buffer to_buffer(reply::status_type status) {
            switch (status) {
                ...
                case reply::not_sync:
                    return boost::asio::buffer(not_sync);
    ...
    namespace stock_replies {
        ...
        const char not_sync[] =
                "<html>"
                "<head><title>Not Syncronized</title></head>"
                "<body><h1>305 Not Syncronized</h1></body>"
                "</html>";
